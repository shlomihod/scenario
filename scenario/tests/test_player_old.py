...
class TestPlayer(TestCase):
    def __generate_scenario_test(self, test_name, strictness=True):
        ...
        scenario['args'] = [test_name.replace('_strict', '').replace('_nonstrict', '')]

        if test_name == 'print':
            scenario['dialogue'] = [
                dict(type='output', name='X', value=line)
            ...
            scenario['dialogue'].append(
                dict(type='input', name='X', value='some text')
            )
            ...
            scenario['dialogue'].append(
                dict(type='output', name='X', value='some text')
            )
            ...
            scenario['dialogue'][3]['value'] = scenario['dialogue'][3]['value'] + ' '
            scenario['dialogue'][5]['value'] = scenario['dialogue'][5]['value'] + '  '
            scenario['dialogue'][7]['value'] = '    '.join(scenario['dialogue'][7]['value'].split())
